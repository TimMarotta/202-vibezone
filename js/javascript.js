...
$(document).ready(function () {
  ...
  $("#john1").click(function () {
    console.log("clicked");
    $("#overlayimg").attr("src", "../img/stickers/ollieallen.png");
    $("#overlay").fadeIn();
  });
  ...
  $("#jojo2").click(function () {
    console.log("clicked");
    $("#overlayimg").attr("src", "../img/stickers/samandcat.png");
    $("#overlay").fadeIn();
  });
  ...
  $("#addfriend").click(function () {
    console.log("clicked");
    if ($("#nofriends").css("display")=="block"){
      $("#nofriends").css("display", "none");
      setTimeout(function() {$("#nofriends").css("display", "block");}, 1000);
    } else {
